...
1. Copy .env/.env.local to root directory .env
2. Create a DB named "boilerplate_logging_database" using MySQL. `(Go to Setup Instructions (below) first to setup everything we need for local development)`
...
4. Create database named "boilerplate_logging_database".
...
3. After you import select the `boilerplate_logging_database` environment on the upper right side of the postman application.
